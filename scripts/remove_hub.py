...
(design\\hub_uninstall_end_state.md's dirty/unpushed check), writing that verdict (plus what was
...
def _build_uninstall_note(this_host, host_results, per_machine_removed, outer_status, toolkit_status,
    ...
    """Builds TOWER_CRANE_UNINSTALLED.md's content (design\\hub_uninstall_end_state.md) - the same
    ...
    lines = [
        ...
        "unaffected regardless of what this file says (design\\hub_uninstall_end_state.md). "
